...
var commentsSwiper = document.querySelector('.comments__swiper');
var buttons = document.querySelectorAll('[data-swiper-button]');

var focusOnActiveCard = function focusOnActiveCard() {
  if (buttons.length) {
...
window.addEventListener('load', function () {
  if (coachesSwiper) {
    var swiperCoaches = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.coaches__swiper', {
  ...
  if (commentsSwiper) {
    var swiperComments = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.comments__swiper', {
      direction: 'horizontal',
      loop: false,
      slidesPerView: 1,
      slidesPerGroup: 1,
